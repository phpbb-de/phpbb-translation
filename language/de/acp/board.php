...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'In den meisten Fällen ist die Cookie-Domain optional. Lasse diese leer, wenn du dir unsicher bist.<br /><br /> Falls du dein Board mit anderer Software integriert hast oder mehrere Domains verwendest, dann kannst du die benötigte Cookie-Domain wie folgt bestimmen: Falls du Domainkombinationen wie <i>example.org</i> und <i>forums.example.org</i> oder auch <i>forums.example.org</i> und <i>blog.example.org</i> verwendest, dann entferne die Subdomains, bis du den gemeinsamen Domainteil gefunden hast; in diesem Beispiel <i>example.org</i>. Nun füge einen Punkt vor den gemeinsamen Domain-Namen und trage das Ergebnis in das Feld ein. In unserem Beispiel würdest du also <i>.example.org</i> einfügen (beachte den Punkt am Anfang).',
