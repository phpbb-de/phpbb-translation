...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Weitere Informationen über die Einrichtung und Verwaltung von Berechtigungen auf Ihrem phpBB3-Board finden Sie <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">im Kapitel „Setting permissions“ der Schnellstartanleitung (englisch)</a> (<a href="https://www.phpbb.de/go/3.3/berechtigungen">deutsche Übersetzung</a>) nach.</p>
	',

	'ACL_NEVER'				=> 'Nie',
	'ACL_SET'				=> 'Berechtigungen setzen',
	'ACL_SET_EXPLAIN'		=> 'Berechtigungen basieren auf einem einfachen <strong>JA/NEIN</strong>-System. Wird eine Einstellung für einen Benutzer oder eine Gruppe auf <strong>NIE</strong> gesetzt, so überschreibt dieser Wert alle anderen gesetzten Werte. Wenn Sie bei diesem Benutzer/dieser Gruppe keinen Wert für eine Einstellung vornehmen möchten, wählen Sie <strong>NEIN</strong> aus. Wenn an anderer Stelle eine abweichende Einstellung vorgenommen wurde, so wird diese verwendet; ansonsten wird von <strong>NIE</strong> ausgegangen. Alle (mit dem davorstehendem Kontrollkästchen) ausgewählten Objekte werden die von Ihnen definierten Berechtigungen übernehmen.  Bitte beachten Sie, dass es keinen Effekt hat Administrator-Berechtigungen für Gründer-Benutzeraccounts zu definieren, da Administrations-Berechtigungen für Gründer-Benutzeraccounts immer auf <strong>JA</strong> eingestellt sind.',
