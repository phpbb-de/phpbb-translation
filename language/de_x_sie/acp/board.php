...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> 'Avatare, die von einer anderen Website verlinkt werden.<br><em><strong class="error">Achtung:</strong> Wenn Sie diese Funktion aktivieren, können Benutzer evtl. die Existenz von Dateien und Diensten prüfen, die nur über das lokale Netzwerk zugänglich sind, in dem sich der Server befindet.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Avatar-Upload von URL aktivieren',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Erlaubt das Hochladen eines Avatars von einer anderen Website.<br><em><strong class="error">Achtung:</strong> Wenn Sie diese Funktion aktivieren, können Benutzer evtl. die Existenz von Dateien und Diensten prüfen, die nur über das lokale Netzwerk zugänglich sind, in dem sich der Server befindet.</em>',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Dieser ist für gewöhnlich identisch mit Ihrem Skript-Pfad oder einfach nur ein Slash (/), um das Cookie auf der ganzen Domain verfügbar zu machen.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Sofern notwendig, können Sie diesen Wert festlegen, um nicht die maximale Anzahl von Empfängern zu überschreiten, die Ihr E-Mail-Server in einer E-Mail zulässt.',
