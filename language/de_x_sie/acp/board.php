...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> 'Avatare, die von einer anderen Website verlinkt werden.<br><em><strong class="error">Achtung:</strong> Wenn Sie diese Funktion aktivieren, können Benutzer evtl. die Existenz von Dateien und Diensten prüfen, die nur über das lokale Netzwerk zugänglich sind, in dem sich der Server befindet.',
	'ALLOW_REMOTE_UPLOAD'			=> 'Avatar-Upload von URL aktivieren',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Erlaubt das Hochladen eines Avatars von einer anderen Website.<br><em><strong class="error">Achtung:</strong> Wenn Sie diese Funktion aktivieren, können Benutzer evtl. die Existenz von Dateien und Diensten prüfen, die nur über das lokale Netzwerk zugänglich sind, in dem sich der Server befindet.',
