...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'In den meisten Fällen ist die Cookie-Domain optional. Lassen Sie diese leer, wenn Sie sich unsicher sind.<br /><br /> Falls Sie Ihr Board mit anderer Software integriert haben oder mehrere Domains verwenden, dann können Sie die benötigte Cookie-Domain wie folgt bestimmen: Falls Sie Domainkombinationen wie <i>example.org</i> und <i>forums.example.org</i> oder auch <i>forums.example.org</i> und <i>blog.example.org</i> verwenden, dann entfernen Sie die Subdomains, bis Sie den gemeinsamen Domainteil gefunden haben; in diesem Beispiel <i>example.org</i>. Nun fügen Sie einen Punkt vor den gemeinsamen Domain-Namen und tragen das Ergebnis in das Feld ein. In unserem Beispiel würden Sie also <i>.example.org</i> einfügen (beachten Sie den Punkt am Anfang).',
