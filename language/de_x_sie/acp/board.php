...
$lang = array_merge($lang, array(
	...
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Anzahl von Tagen, nach denen gelesene Benachrichtungen automatisch gelöscht werden. Stellen Sie einen Wert von 0 ein, damit Benachrichtigungen dauerhaft erhalten bleiben.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Für jeden OAuth-Anbieter wird sowohl ein eindeutiger Key <em>(Schlüssel)</em> als auch ein Secret <em>(Geheimnis)</em> benötigt, um eine Authentifizierung vornehmen zu können.<br />Diese sollten Ihnen vom OAuth-Provider bei der Registrierung Ihrer Website bereitgestellt werden und exakt so eingegeben werden, wie sie bereitgestellt wurden.<br />Ein Anbieter, für den nicht sowohl Key als auch Secret angegeben wurde, wird den Benutzern deines Forums nicht zur Verfügung stehen.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_DISABLED'					=> 'Das Modul <strong>mod_rewrite</strong> deines Apache-Webservers ist deaktiviert. Aktivieren Sie das Modul oder kontaktieren Sie Ihren Webhosting-Provider, wenn Sie wollen, dass diese Funktion aktiviert wird.',
...
$lang = array_merge($lang, array(
	...
	'AUTOLOGIN_LENGTH_EXPLAIN'		=> 'Die Anzahl der Tage, nach denen ein Anmelde-Schlüssel für die dauerhafte Anmeldung verfällt. Um den Schlüssel nicht verfallen zu lassen, stellen Sie als Wert 0 ein.',
