...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Der Pfad von Ihrem phpBB-Hauptverzeichnis aus, in dem die Avatare gespeichert werden (z.&nbsp;B. <samp>images/avatars/upload</samp>).<br />Das Hochladen von Avataren <strong>wird nicht funktionieren</strong>, wenn dieser Ordner nicht beschreibbar ist.',
...
$lang = array_merge($lang, array(
	...
	'BOXES_LIMIT_EXPLAIN'		=> 'Benutzer können in einem Ordner nicht mehr als die hier festgelegte Anzahl an Privaten Nachrichten ablegen. Um eine unbegrenzte Anzahl zuzulassen, muss 0 als Wert eingestellt werden.',
...
$lang = array_merge($lang, array(
	...
	'SMILIES_LIMIT_EXPLAIN'			=> 'Die maximale Anzahl an Smilies in einem Beitrag. Es wird keine Begrenzung festgelegt, wenn 0 als Wert eingestellt wird.',
...
$lang = array_merge($lang, array(
	...
	'MAX_SIG_SMILIES_EXPLAIN'		=> 'Die maximal erlaubte Anzahl an Smilies in der Signatur. Es wird keine Begrenzung festgelegt, wenn 0 als Wert eingestellt wird.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Für jeden OAuth-Anbieter wird sowohl ein eindeutiger Key <em>(Schlüssel)</em> als auch ein Secret <em>(Geheimnis)</em> benötigt, um eine Authentifizierung vornehmen zu können.<br />Diese sollten Ihnen vom OAuth-Provider bei der Registrierung Ihrer Website bereitgestellt werden und exakt so eingegeben werden, wie sie bereitgestellt wurden.<br />Ein Anbieter, für den nicht sowohl Key als auch Secret angegeben wurde, wird den Benutzern Ihres Forums nicht zur Verfügung stehen.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_DISABLED'					=> 'Das Modul <strong>mod_rewrite</strong> Ihres Apache-Webservers ist deaktiviert. Aktivieren Sie das Modul oder kontaktieren Sie Ihren Webhosting-Provider, wenn Sie wollen, dass diese Funktion aktiviert wird.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Dieser Name für den Kontakt wird E-Mail-Empfängern angezeigt. Wenn Sie keinen Namen für den Kontakt verwenden wollen, lassen Sie dieses Feld leer.',
