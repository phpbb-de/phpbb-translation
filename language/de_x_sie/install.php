...
$lang = array_merge($lang, array(
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Ihr MySQL-Datenbankschema ist veraltet. phpBB hat ein Schema für MySQL 3.x/4.x erkannt, der Server läuft aber mit MySQL %2$s.<br /><strong>Sie müssen das Schema aktualisieren, um mit dem Update fortfahren zu können.</strong><br /><br />Bitte verfahren Sie dabei wie im <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge-Base-Artikel zur Aktualisierung des MySQL-Schemas</a> beschrieben wird (<a href="https://www.phpbb.de/go/3/no_default">deutschsprachige Fassung</a>. Wenn Sie dabei Probleme auf Probleme stoßen, nutzen Sie bitte <a href="https://www.phpbb.com/community/viewforum.php?f=46">unsere Support-Foren</a> (<a href="https://www.phpbb.de/go/3/supportforum">deutschsprachige Foren</a>).',
	...
	'SELECT_FORUM_GA'			=> 'In phpBB 3.1 sind Globale Bekanntmachungen mit Foren verknüpft. Wählen Sie ein Forum für Ihre aktuellen globalen Bekanntmachungen aus (Sie können sie später verschieben):',
...
$lang = array_merge($lang, array(
	...
	'FILES_DELETED'					=> 'Gelöschte Dateien',
