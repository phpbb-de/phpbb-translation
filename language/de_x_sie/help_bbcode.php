...
* siehe language/de_x_sie/AUTHORS.md und https://www.d/go/ubersetzerteam
*
*/
...
$help = array(
	...
	array(
		...
		1 => 'phpBBs BBCode unterstützt mehrere Wege, um URIs (Uniform Resource Indicators), auch als URLs oder Links bekannt, zu erstellen.<ul><li>Der erste davon ist der <strong>[url=][/url]</strong>-Tag; alles, was Sie nach dem =-Zeichen angeben, wird als Link für den Inhalt des Tags verwendet. Um beispielsweise auf example.org zu linken, können Sie folgenden Code verwenden:<br /><br /><strong>[url=https://www.example.org/]</strong>Besuche example.org!<strong>[/url]</strong><br /><br />Dies würde folgenden Link erstellen: <a href="https://www.example.org/">Besuche example.org!</a> Die Seite wird abhängig von den Einstellungen des Browsers des Benutzers im gleichen oder in einem neuen Fenster geöffnet.</li><li>Wenn Sie möchten, dass die URL selbst als Beschreibung angezeigt wird, können Sie dies wie folgt erreichen:<br /><br /><strong>[url]</strong>https://www.example.org/<strong>[/url]</strong><br /><br />Dies würde folgenden Link erstellen: <a href="https://www.example.org/">https://www.example.org/</a></li><li>phpBB hat zusätzlich eine Funktion, um Links automatisch zu erkennen. Diese Funktion wandelt jede syntaktisch korrekte URL in einen Link um, ohne dass Sie einen Tag oder sogar das führende https:// angeben müssen. Wenn Sie zum Beispiel in Ihrem Text www.example.org schreiben, so wird dies automatisch zu <a href="https://www.example.org/">www.example.org</a>, sobald Sie die Nachricht betrachten.</li><li>Die selbe Funktionalität steht auch bei E-Mail-Adressen zur Verfügung. Sie können entweder eine Adresse explizit kennzeichnen; z.&nbsp;B.:<br /><br /><strong>[email]</strong>niemand@example.org<strong>[/email]</strong><br /><br />Dies ergibt <a href="mailto:niemand@example.org">niemand@example.org</a>. Oder Sie können direkt niemand@example.org in Ihrer Nachricht verwenden, was automatisch umgewandelt wird, wenn Sie die Nachricht anschauen.</li></ul>Wie bei allen BBCode-Tags können Sie URLs all den anderen Tags wie <strong>[img][/img]</strong> (siehe nächsten Eintrag), <strong>[b][/b]</strong> usw. hinterlegen. Wie bei den Formatierungs-Tags liegt es an Ihnen, die richtige Reihenfolge beim Öffnen und beim Schließen einzuhalten. So ist zum Beispiel:<br /><br /><strong>[url=https://www.phpbb.com/][img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/url][/img]</strong><br /><br /><span style="text-decoration: underline">nicht</span> richtig und kann dazu führen, dass Ihr Beitrag gelöscht wird.',
	),
	array(
		0 => '--',
