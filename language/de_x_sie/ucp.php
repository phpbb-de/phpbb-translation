...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '<p>Mit dem Zugriff auf „%1$s“ („%2$s“) wird zwischen Ihnen und dem Betreiber ein Vertrag mit folgenden Regelungen geschlossen:</p>
		...
		<ol style="list-style-type: lower-alpha"><li>Sie nehmen zur Kenntnis, dass es sich bei phpBB um eine unter der „<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>“ (GPL) bereitgestellten Foren-Software von phpBB Limited (<a href="https://www.phpbb.com/">www.phpbb.com</a>) handelt; deutschsprachige Informationen werden durch die deutschsprachige Community unter www.phpbb.de zur Verfügung gestellt. Beide haben keinen Einfluss auf die Art und Weise, wie die Software verwendet wird. Sie können insbesondere die Verwendung der Software für bestimmte Zwecke nicht untersagen oder auf Inhalte fremder Foren Einfluss nehmen.</li></ol>
	...
	'PRIVACY_POLICY'		=> '<p>Diese Richtlinie beschreibt, wie „%1$s“ („%2$s“) (im Folgenden „der Betreiber“) die Daten verwendet, die während Ihres Foren-Besuchs gesammelt werden.</p>
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Vielen Dank für die Registrierung, Ihr Benutzerkonto wurde erstellt.',
	...
	'ACTIVATION_EMAIL_SENT'			=> 'Eine Aktivierungs-E-Mail wurde an die eingegebene Adresse versendet, sofern der eingegebene Benutzername und die E-Mail-Adresse korrekt sind. Aktivierungs-E-Mails sind je Benutzeraccount auf maximal eine E-Mail alle 24 Stunden beschränkt. Sollten Sie weiterhin Probleme beim Aktivieren Ihres Accounts haben, kontaktieren Sie bitte einen Board-Administrator.',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> 'Eine Benachrichtigungs-E-Mail wurde an die E-Mail-Adressen der Administratoren gesendet, sofern der eingegebene Benutzername und die E-Mail-Adresse korrekt sind. Aktivierungs-E-Mails sind je Benutzeraccount auf maximal eine E-Mail alle 24 Stunden beschränkt. Sollten Sie weiterhin Probleme beim Aktivieren Ihres Accounts haben, kontaktieren Sie bitte einen Board-Administrator.',
	'ADD'							=> 'Hinzufügen',
	'ADD_BCC'						=> '[ BCC ]',
	...
	'ATTACHMENT_LOCKED'				=> 'Dieses Thema ist gesperrt. Sie können den Dateianhang nicht löschen.',
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'Jemand antwortet auf ein Thema in einem Forum, das Sie abonniert haben',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Ihre Meldung zu einem Beitrag wurde von einem Moderator geschlossen',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Sie sind nicht berechtigt, Private Nachtrichten auszudrucken.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Die angegebene E-Mail-Adresse ist mehreren Benutzern zugeordnet. Sie müssen zusätzlich den Benutzernamen angeben.',
	...
	'PASSWORD_RESET_LINK_SENT'	=> 'Sofern ein passendes Benutzerkonto existiert, wurde ein Link zum Zurücksetzen des Passworts an Ihre registrierte E-Mail-Adresse gesendet.',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Das von Ihnen angegebene Token zum Zurücksetzen des Passworts ist ungültig oder abgelaufen.',
